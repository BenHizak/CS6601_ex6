...
def part_1_a():
    ...
    a_transition_probs = {
        'A1': {'A2': 0., 'A3': 0., 'A1': 0., 'Aend': 0.},
        'A2': {'A1': 0., 'A2': 0., 'A3': 0., 'Aend': 0.},
        'A3': {'A2': 0., 'A1': 0., 'A3': 0., 'Aend': 0.},
        'Aend': {'A2': 0., 'A3': 0., 'A1': 0., 'Aend': 0.}
    }
    ...
    s_transition_probs = {
        'S1': {'S1': 0., 'S3': 0., 'S2': 0., 'Send': 0.},
        'S2': {'S1': 0., 'S2': 0., 'S3': 0., 'Send': 0.},
        'S3': {'S1': 0., 'S3': 0., 'S2': 0., 'Send': 0.},
        'Send': {'S3': 0., 'S2': 0., 'S1': 0., 'Send': 0.}
    }
    # Parameters for end state is not required͏󠄂͏️͏󠄌͏󠄎͏︆͏︋͏󠄏
    s_emission_paras = {
        'S1': (None, None),
...
def part_2_a():
    ...
    # example: {'A1': [(right-hand-mean, right-hand-std), (right-thumb-mean, right-thumb-std)] ...}͏󠄂͏️͏󠄌͏󠄎͏︆͏︋͏󠄏
    a_emission_paras = {
...
def return_your_name():
    """Return your name
    """
    # TODO: finish this͏󠄂͏️͏󠄌͏󠄎͏︆͏︋͏󠄏
    raise NotImplementedError()
